...
def inject_custom_css() -> None:
    ...
    st.html(
        ...
        .lobby-shell {{
            ...
            border-radius: 32px;
            background-image:
                linear-gradient(90deg, rgba(255,255,255,.99) 0%, rgba(255,255,255,.93) 44%, rgba(255,255,255,.18) 70%),
                {lobby_background},
        ...
        .hero-section {{
            ...
            color: {C_TEXT};
            background-image:
                linear-gradient(90deg, rgba(255,255,255,.99) 0%, rgba(255,255,255,.95) 44%, rgba(255,255,255,.22) 68%),
                {hero_background},
            ...
            background-size: cover, cover, cover;
            border: 1px solid #BFDBFE;
            box-shadow: 0 18px 42px rgba(11,94,215,.13);
        }}
        ...
        .hero-section::before {{
            ...
            opacity: .12;
            background-image:
                linear-gradient(rgba(16,142,233,.18) 1px, transparent 1px),
                linear-gradient(90deg, rgba(16,142,233,.18) 1px, transparent 1px);
        ...
        .conclusion-visual {{
            ...
            width: min(190px, 28%);
            max-height: 190px;
            margin: -.4rem -.2rem .8rem 1rem;
            object-fit: contain;
            filter: drop-shadow(0 14px 24px rgba(11,94,215,.13));
        }}
        ...
        .control-panel-brand {{
            ...
            box-shadow: 0 8px 20px rgba(3,31,84,.15);
        }}
        ...
        @media (max-width: 800px) {{
            ...
            .hero-section {{
                ...
                border-radius: 21px;
                background-image:
                    linear-gradient(90deg, rgba(255,255,255,.99) 0%, rgba(255,255,255,.92) 72%, rgba(255,255,255,.55) 100%),
                    {hero_background},
                    linear-gradient(135deg, #FFFFFF 0%, #EAF5FF 100%);
            ...
            .lobby-shell {{
                ...
                border-radius: 24px;
                background-image:
                    linear-gradient(180deg, rgba(255,255,255,.98) 0%, rgba(255,255,255,.88) 62%, rgba(255,255,255,.45) 100%),
                    {lobby_background},
...
def questionnaire_chart(
    ...
    height = max(620, min(700, len(ordered) * 29 + 100))
    figure = go.Figure(
        go.Bar(
            x=ordered["rata_rata"],
            y=ordered["label"],
    ...
    st.html(
        ...
        <section class="lobby-shell fade-in">
            <div class="lobby-hero">
                ...
                <div class="lobby-visual" aria-hidden="true"></div>
            </div>
...
def render_output_and_presentation(
    ...
    with intro_column:
        ...
        st.write(
            "Dashboard langsung membuka halaman analitik. Lobby visual tetap dapat "
            "ditampilkan saat membutuhkan cover pembuka presentasi."
        )
        if st.button(
            "Tampilkan Lobi",
