...
def inject_custom_css() -> None:
    ...
    st.html(
        ...
        .lobby-shell {{
            ...
            border-radius: 28px;
            background:
                radial-gradient(circle at 82% 18%, rgba(56,189,248,.22), transparent 25%),
                radial-gradient(circle at 66% 82%, rgba(37,99,235,.10), transparent 28%),
                linear-gradient(105deg, #FFFFFF 0%, #F8FCFF 48%, #EAF5FF 100%);
        ...
        <section class="lobby-shell fade-in">
            <div class="lobby-hero">
                ...
                <div class="lobby-visual" aria-hidden="true">
                    {asset_img_tag("dana_hero_full_1600x900.png", alt="")}
                </div>
            </div>
